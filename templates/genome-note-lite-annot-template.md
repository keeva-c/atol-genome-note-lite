...
Table: Table 5: Genome assembly information for {{ assembly.assembly_name|default("*genome assembly name*",true) }}, sequenced from *{{ taxonomy_info.ncbi_scientific_name }}*.{% endif %}{% if assembly.haplotypes == 0 %}| **Assembly information** | | **EBP standard** |
| --- | ---- | -- |
