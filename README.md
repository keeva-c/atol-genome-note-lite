...
The [`combined_parser.py`](https://github.com/keeva-c/atol-genome-note-lite/blob/main/src/atol_genome_note_lite/combined_parser.py) script can be used to parse ouput files genreated during the assembly and QC processes to extract and format the metrics and information required to generate the genome note lite. Assembly output files which can be parsed include:
 ...
 - contact maps, 
 - GenomeScope2 kmer plots,
 - mitogenome stats, and
 - list of autofiltered sequences generated by ASCC.

### Full usage:

```
usage: combined_parser.py [-h] [--busco BUSCO [BUSCO ...]] [--kmer KMER] [--qv QV] [--summary SUMMARY [SUMMARY ...]] [--assembly_software ASSEMBLY_SOFTWARE] [--map [MAP ...]] [--kmer_plot [KMER_PLOT]] [--mito [MITO]] [--ascc_software ASCC_SOFTWARE] [--treeval_software [TREEVAL_SOFTWARE]] [--autofiltered_output [AUTOFILTERED_OUTPUT ...]] [--metadata [METADATA]] [--output OUTPUT] [--full_json FULL_JSON] [--phased]
...
options:
  -h, --help            show this help message and exit
  --phased              select this option to extract metrics for phased assemblies. Metrics will be extracted for both haplotypes if sufficient data is proivided. (default: False)

Input:
  --busco BUSCO [BUSCO ...]
                        the JSON summary file generated during BUSCO analysis of the assembly - the file should end with busco.json. Include two summaries for phased haplotypes. (default: None)
  ...
  --summary SUMMARY [SUMMARY ...]
                        the summary text file generated when using the sanger_tol assembly pipeline - the file should end with .assembly_summary. Include two summaries for phased haplotypes. (default: None)
  --assembly_software ASSEMBLY_SOFTWARE
                        the YAML file summarising the tools and versions used by the assembly pipeline - the file should end with genomeassembly_software_versions.yml (default: None)
  --map [MAP ...]       the PreText Snapshot PNG file of the contact map generated during assembly scaffolding - the file should end with FullMap.png. Include two files for phased haplotypes. (default: None)
  --kmer_plot [KMER_PLOT]
  ...
  --ascc_software ASCC_SOFTWARE
                        the YAML file summarising tools and versions used by the ASCC decontamination pipeline - the file should end with ascc_software_versions.yml (default: None)
  --treeval_software [TREEVAL_SOFTWARE]
                        the YAML file summarising tools and versions used by the treeval pipeline - the file should end with treeval_software_versions.yml (default: None)
  --autofiltered_output [AUTOFILTERED_OUTPUT ...]
                        the txt file listing sequences automatically removed from the assembly during ascc - the file should end with assembly_filtering_removed_sequences.txt. Include two files for phased haplotypes - include asm_hap1 and asm_hap2 in the file names. (default: None)
  --metadata [METADATA]
